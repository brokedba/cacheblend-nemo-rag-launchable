...
LMCACHE_METRICS_URL = os.environ.get("LMCACHE_METRICS_URL", "http://localhost:8080/metrics")
...
def rag_stream(
    ...
    # per-request deltas — lifetime ratios mislead across arms
    try:
